///
/// This runs everything, it starts a fresh campaign, so to use it start by creating a map, it automatically saves, then you click save campaign, it saves the campaign, u can load it and display the maps in it, and the actual map itself..
///
///
///
///
				...
				do
				{
					...
					else 
					{
						if (m.GetCell(row - 1, col - 1) == CHAR_WALL)
							m.StoreCell(row - 1, col - 1, CHAR_EMPTY);
