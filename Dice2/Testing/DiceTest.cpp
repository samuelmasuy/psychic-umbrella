#include "DiceTest.h" // this is included as it is where we created and specificed the Dice Class
...
#include <iostream> //This library includes basic input and output services such as "cout" in this case
